...
urlpatterns = patterns('',
    ...
    # all call-admin related views
    url(r'^intake/call/(?P<call_id>\d*)/$', 'intake.views.call', name='call'),
    url(r'^intake/calls/$', 'intake.views.calls', name='calls'),
    url(r'^intake/calls_data/$', 'intake.views.calls_data', name='calls_data'),
